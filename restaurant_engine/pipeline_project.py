...
def _print_summary(report, report_path: Path) -> None:
    ...
    print(f"cover_plan: {report.cover_plan_path}")
    print(f"cover_planner: {report.cover_planner}")
    print(f"cover_render_status: {report.cover_render_status}")
    print(f"cover_selected_image_id: {report.cover_selected_image_id}")
    print(f"cover_selected_title: {report.cover_selected_title}")
    print(f"cover_title_candidates_count: {report.cover_title_candidates_count}")
    print(f"cover_title_user_selected: {report.cover_title_user_selected}")
    print(f"cover_requires_human_review: {report.cover_requires_human_review}")
    print(f"cover_blocking: {report.cover_blocking}")
    print(f"cover_render_report: {report.cover_render_report_path}")
    print(f"cover_renderer: {report.cover_renderer}")
    print(f"cover_rendered_image_path: {report.cover_rendered_image_path}")
    print(f"cover_render_source_image_id: {report.cover_render_source_image_id}")
    print(f"cover_render_title_text: {report.cover_render_title_text}")
    print(f"cover_render_blocking: {report.cover_render_blocking}")
