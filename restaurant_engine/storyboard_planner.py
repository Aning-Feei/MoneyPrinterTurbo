...
def build_deepseek_storyboard_messages(
    ...
    user_prompt = (
        ...
        "Each narration must be a natural Chinese short sentence, preferably "
        "at least 8 Chinese characters, and must not be an overly short phrase. "
        "Do not return mock, placeholder, TODO, 待填写, or Markdown content. "
        "Keep scene count and image order exactly as provided; durations will "
        "be normalized locally after planning. "
